...
<head>
    <meta charset="UTF-8">
    <title>Zuid-Amerikaanse kruiden</title>
    ...
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            try {
                ...
                $stmt = $conn->prepare("SELECT * FROM producten WHERE continent = 3");
                $stmt->execute();
                ...
                foreach ($producten as $key => $value) {
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <p><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;<?php echo $value['beschrijving']; ?></p>
                            </td>
                        </tr><tr>
                            <td>

                                <p><a onclick="window.location.href='winkelwagen.php?id=<?php echo $value['id']; ?>'"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span>&nbsp&nbsp;€<?php echo $value['prijs']; ?><br></a></p>
                            </td>
                        </tr>
                        </tbody>
                    </table>
